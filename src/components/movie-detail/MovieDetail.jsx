...
import { getNumberWithComma, getHHMMFomat } from "../../app/common/commonUtil";
        ...
        <div className="movie-data-meta">
          <div className="movie-meta-data">
            ...
            movie.production_companies.length ? (
              <p className="movie-producers">
                {movie.production_companies.map((com) => com.name).join(", ")}
              </p>
            ) : null}
          </div>
          ...
          <div className="movie-meta">
            ...
            <p className="movie-meta-value">{getHHMMFomat(movie.runtime)}</p>
          </div>
          <div className="movie-meta">
            <h4 className="movie-meta-key">Box Office:</h4>
            <p className="movie-meta-value">
              {`$${getNumberWithComma(movie.revenue)}`}
            </p>
          </div>
          <div className="movie-meta">
